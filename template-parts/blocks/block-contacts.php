...
<script
    src="https://api-maps.yandex.ru/2.1/?apikey=68f9a0ea-6fba-4a6e-9f0a-5a716b0b30d5&lang=<?php echo $lang; ?>"></script>
                            ...
                            <?php if ($contacts_tellink && $contacts_tel): ?>
                                <div class="phone d-flex row gx-4 align-items-center">
                                    ...
                                    <h4 class="text-black col">
                                        <a class="text-black"
                                            href="tel:+7<?php echo $contacts_tellink; ?>"><?php echo $contacts_tel; ?></a>
                                    </h4>
                                </div>
                            <?php endif; ?>

                            <a class="reserve-btn btn-book mt-5 animated fadeInUp" style="display: block; width: fit-content"
                                href="#popmake-694"><?php the_field('book-title_en', 'options'); ?></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-5 col-12 gx-5" data-aos="slide-right">
                        ...
                        <div class="info">
                            ...
                            <a class="reserve-btn btn-book mt-5 animated fadeInUp" href="#popmake-694"
                                style="display: block; width: fit-content"><?php the_field('book-title', 'options'); ?></a>
                        </div>
                    </div>
