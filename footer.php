...
<footer id="footer" class="light">
                        ...
                        if (get_locale() == 'en_US') {
                            ...
                            if ($logoImg_en): ?>
                                <a class="logo me-auto me-lg-0 d-block mb-60" href="/en/">
                                    <img src="<?php echo esc_url($logoImg_en['url']); ?>"
                                        alt="<?php echo esc_attr($logoImg_en['alt']); ?>">
                                </a>
                            <?php endif; ?>
                            <!-- RU -->
                        <?php
                            ...
                            if ($logoImg): ?>
                                <a class="logo me-auto me-lg-0 d-block mb-60" href="/">
                                    <img src="<?php echo esc_url($logoImg['url']); ?>"
                                        alt="<?php echo esc_attr($logoImg['alt']); ?>">
                                </a>
                            <?php endif; ?>
                            <?php
                        }
                        ...
                        if ($social['telegram'] || $social['vk'] || $social['whatsapp']): ?>
                            <div class="social-links mt-3">
                                <?php if ($social['telegram']): ?>
                                    <a href="https://t.me/<?php echo $social['telegram']; ?>" class="social"><i
                                            class="telegram"></i></a>
                                <?php endif; ?>
    ...
    <div class="container">
        ...
        if (get_locale() == 'en_US') {
            ...
            <?php if ($copyright_en): ?>
                <div class="copyright">
                ©&nbsp;<?php echo date("Y"); ?>&nbsp; <?php echo $copyright_en; ?>
                </div>
            <?php endif; ?>
            <!-- RU -->
        <?php
